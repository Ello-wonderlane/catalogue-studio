    ...
    <div className="grid2" style={{ gridTemplateColumns: "380px 1fr", alignItems: "start" }}>
      <div className="panel">
        ...
        {mode === "single" ? (<>
          ...
          <div className="field"><label>Product photos (many)</label><input type="file" accept="image/*" multiple onChange={onFiles} /><div className="note">Name files with the SKU (e.g. <span className="mono">YSWHA0154PCB.jpg</span>) and results are auto-linked as thumbnails.</div></div>
          {settings}
